...
class Projeto(models.Model):
    ...
    codigo = models.CharField(max_length=50, unique=True, verbose_name="Código da Obra", null=True, blank=True)
...
class Veiculo(models.Model):
    ...
    descricao = models.CharField(max_length=100, blank=True, null=True, verbose_name="Modelo/Descrição")
...
class Apontamento(models.Model):
    ...
    data_apontamento = models.DateField(default=timezone.now, verbose_name="Data")
    ...
    # Se for veículo da frota, usa a FK. Se for externo/alugado, usa os campos manuais.
    ...
    veiculo_manual_modelo = models.CharField(max_length=100, blank=True, null=True, verbose_name="Modelo (Manual)")
    veiculo_manual_placa = models.CharField(max_length=20, blank=True, null=True, verbose_name="Placa (Manual)")

    # --- 3. Contexto do Trabalho (Condicional) ---
    # Campos usados se local_execucao == 'INT' (Obra)
    projeto = models.ForeignKey(Projeto, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Projeto")
    ...
    local_inicio_jornada_outros = models.CharField(max_length=100, blank=True, null=True, verbose_name="Detalhe Outros")
    
    # Campos usados se local_execucao == 'EXT' (Fora)
    setor = models.ForeignKey(Setor, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Setor / Justificativa")
    ...
    # Armazena IDs extras separados por vírgula (Ex: "1,4,8")
    auxiliares_extras_ids = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        ...
        ordering = ['-data_apontamento', '-id'] # Ordena do mais recente para o mais antigo
